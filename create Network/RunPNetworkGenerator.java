...
public class RunPNetworkGenerator {
    ...
    public static void main(String[] args) {
         ...
         * The input file name.
         */
        String osm = "C:\\Users\\miche\\OneDrive\\Dokument\\urop\\cambodia-latest.osm\\merged.osm";
        ...
        CoordinateTransformation ct =
                TransformationFactory.getCoordinateTransformation(TransformationFactory.WGS84, TransformationFactory.WGS84_UTM48N);
         ...
         */
        new NetworkWriter(network).write("C:\\Users\\miche\\OneDrive\\Dokument\\urop\\cambodia-latest.osm\\matsim-network_merged.xml");
